    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          (0, _alerts.showAlert)('error', 'Logged out Failed');
        case 3:
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
          url = type === 'password' ? 'updatePassword' : 'updateMe'; // Access Url -> Run all middlewares are related to our URL
          _context.n = 1;
          return (0, _axios.default)({
            method: 'PATCH',
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return (0, _stripeJs.loadStripe)('pk_test_51Rezun4GnGF8nSEh3MkUvV6KPjHGTOpRlKmoymggrWEQHUyfwCkD5XkibwtJDO91pkO5tmqQEeWzgwhLVSsjrJU400enx0V8H8');
        case 1:
          stripe = _context.v;
          _context.n = 2;
          return (0, _axios.default)({
...
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { if (r) i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n;else { function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); } o("next", 0), o("throw", 1), o("return", 2); } }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // import { display_map } from './mapbox.js';
// EVENTS
var mapbox = document.getElementById('map');
var logoutButton = document.querySelector('.nav__el--logout');
var savingPasswordBtn = document.querySelector('.btn--save-password');
var loginForm = document.querySelector('.form--login');
var SaveSettingForm = document.querySelector('.form-user-data');
...
var ConfirmNewPassword = document.getElementById('password-confirm');
...
if (SaveSettingForm) {
  SaveSettingForm.addEventListener('submit', function (e) {
    e.preventDefault();
